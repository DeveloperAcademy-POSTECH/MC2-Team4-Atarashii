...
struct CardTemplate: View {
    ...
    var body: some View {
        ZStack {
            ...
            CardFront(degree: $frontDegree, isLiked: $isLiked, isMine: $isMine, isQRCodePresented: $isQRCodePresented, QRAnimation: $QRAnimation, userInfo: userInfo)
        }
        .gesture(drag)
    }
...
struct CardBack: View {
    ...
    var body: some View {
        ...
        .frame(height: 490)
        /// TODO: 컬러 extension 추가 후 적용
        .background(cardColorList[userInfo.cardColor].opacity(0.6))
        .cornerRadius(32)
        .rotation3DEffect(Angle(degrees: degree), axis: (x: 0, y: 1, z: 0))
